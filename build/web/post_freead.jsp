        ...
        <div class="body" style="height: 1200px; margin-top: 50px">
            ...
            <div class="center" style="height: 1000px">
                ...
                <div class="content">
                    ...
                    <form class="form-horizontal" id="data" method="POST" action="SaveFreeAd" enctype="multipart/form-data">
                        <fieldset>
                            ...
                            <!-- Text input-->
                            <div class="form-group">
                                <label class="col-md-4 control-label" onkeypress="return numonly()" for="cmpny">Price</label>  
                                <div class="col-md-4">
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-md-4">
                                    <input id="phone" name="phone" onkeypress="return contact(this.id)" type="tel" maxlength="10" max="2000000000" placeholder="Phone" class="form-control input-md" required="">
