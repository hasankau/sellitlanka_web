            ...
            <div class="center" style="height: 1200px">
                ...
                <div class="content">
                    <center>
                        ...
                        <div class="col-lg-12 container" style="margin-top: 150px">
                        <a href="post_freead.jsp" style="margin: auto;" class="btn btn-lg btn-info">Free Ad</a>
                        <h1>No payment required</h1>
                    </div>
                        <br>
                        
                    <div class="col-lg-12 container">
                        <a href="post_ad.jsp" style="margin: auto;" class="btn btn-lg btn-success">Top Ad</a>
                    </div>
                        <h1>Get more people to see your ad</h1>
                    </center>
