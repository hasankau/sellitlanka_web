 ...
 * @author User
 */
public class SaveFreeAd extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            Session s = Model.Sess.getIntance();
            ...
            if (request.getSession().getAttribute("Login") != null) {
                ...
                Transaction tr = s.beginTransaction();
                    ...
                    ad.setAdType((AdType) s.load(POJOS.AdType.class, 1));
                    ad.setContent(cont);
                    ad.setEmail(email);
                    ad.setPaid(Boolean.TRUE);
                    ad.setDate(new Date());
                ...
                tr = null;
                response.sendRedirect("ad_freeposted.jsp");
